...
import com.ananya.xinder.adapters.LikeAdapter.ContactViewHolder
import com.ananya.xinder.entities.Like
import com.thecode.tinderclone.R

class LikeAdapter(private val context: Context, private val likeList: List<Like>) : RecyclerView.Adapter<ContactViewHolder>() {
