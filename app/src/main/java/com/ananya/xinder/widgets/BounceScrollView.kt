 ...
 */
package com.ananya.xinder.widgets
...
class BounceScrollView(context: Context, attrs: AttributeSet?, defStyleAttr: Int) : NestedScrollView(context, attrs, defStyleAttr) {
            ...
            MotionEvent.ACTION_MOVE -> {
                ...
                if (onePointerTouch && canMove(dampingDelta)) {
                    ...
                    if (isScrollHorizontally) {
                        mChildView!!.layout(mChildView!!.left - dampingDelta, mChildView!!.top,
                                mChildView!!.right - dampingDelta, mChildView!!.bottom)
                    } else {
                        mChildView!!.layout(mChildView!!.left, mChildView!!.top - dampingDelta,
    ...
    init {
        ...
        mDamping =
                a.getFloat(R.styleable.BounceScrollView_damping, DEFAULT_DAMPING_COEFFICIENT)
        ...
        mBounceDelay =
                a.getInt(R.styleable.BounceScrollView_bounceDelay, DEFAULT_BOUNCE_DELAY.toInt()).toLong()
